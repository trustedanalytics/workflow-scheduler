 ...
 */
package org.trustedanalytics.scheduler.security;
...
public class SystemEnvironment {
    ...
    public Configuration getHadoopConfiguration() throws IOException {
        ...
        configParams.entrySet()
                    .forEach(pair -> configuration.set(pair.getKey(), pair.getValue()));
        ...
        while ((zipFileEntry = ((ZipInputStream) zipInputStream).getNextEntry()) != null) {
            ...
            try {
                ...
                for (int i = 0; i < nodeList.getLength(); i++) {
                    ...
                    String key =
                        (String) xPath.evaluate("name/text()", propNode, XPathConstants.STRING);
                    String value =
                        (String) xPath.evaluate("value/text()", propNode, XPathConstants.STRING);
                    map.put(key, value);
                }
